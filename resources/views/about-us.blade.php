            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="index.html" class="nav-item nav-link">Home</a>
                        ...
                        <a href="project.html" class="nav-item nav-link active">About us</a>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <h2 class="mt-2">Tentang Alvian Production</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p><i class="fa fa-map-marker-alt me-3"></i>Aliyan, Rogojampi, Banyuwangi 68462</p>
                        <p><i class="fa fa-phone-alt me-3"></i>+62 81235026920</p>
                        <p><i class="fa fa-envelope me-3"></i>alvianfirdaus@gmail.com</p>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <a class="btn btn-link" href="">Photografi</a>
                        <a class="btn btn-link" href="">Videografi</a>
                        <a class="btn btn-link" href="">Live Streaming & Broadcasting</a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <h5 class="text-white mb-4">Program Kami</h5>
                        <div class="row g-2">
                            <div class="col-4">
                                <img class="img-fluid" src="img/p1.png" alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="img/p2.png" alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="img/p3.png" alt="Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <h5 class="text-white mb-4">News</h5>
                        <p>cek halaman berita disana ada berita untuk kamu</p>
